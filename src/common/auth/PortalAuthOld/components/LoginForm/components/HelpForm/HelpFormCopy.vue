...
<div class="vue-help-container">
  <div class="vue-help-button-wr">
    <button @click.prevent.stop="openHelpModal()" type="button" class="vue-btn vue-btn-warn"><strong>Отправить сообщение в поддержку</strong></button>
  </div>
      ...
      <template v-else>
        ...
        <template v-else>
          <div class="vue-sendhelpform-container">
            <form @submit.prevent="validateForm()" method="post" class="vue-sendhelpform">
              <fieldset class="vue-fieldset">
                <div class="vue-form-item vue-sendhelpform-fio-wr">
                  ...
                  <input @focus="processOnFosus(fioInput)" type="text" name ="vue-sendhelpform-input" class="vue-form-control" :class="{'vue-input-error':errorStyleFio}" id="vue-sendhelpform-input" v-model="fioInput">
                </div>
                <div class="vue-form-item vue-sendhelpform-muname-wr">
                  ...
                  <input @focus="processOnFosus(muInput)" name ="vue-sendhelpform-muname-input" type="text" class="vue-form-control" :class="{'vue-input-error':errorStyleMu}" id="vue-sendhelpform-muname-input" v-model="muInput">
                </div>
                <div class="vue-form-item vue-sendhelpform-login-wr">
                  ...
                  <input @focus="processOnFosus(loginInput)" name ="vue-sendhelpform-login-input" type="text" class="vue-form-control" :class="{'vue-input-error':errorStyleLogin}" id="vue-sendhelpform-login-input" v-model="loginInput">
                </div>
                <div class="vue-form-item vue-sendhelpform-message-wr">
                  ...
                  <textarea rows="7" @focus="processOnFosus(messInput)" name ="vue-sendhelpform-message-input" class="vue-form-control" :class="{'vue-input-error':errorStyleMess}" id="vue-sendhelpform-message-input" v-model="messInput"></textarea>
                </div>
                ...
                <div class="vue-form-item vue-sendhelpform-telusername-wr">
                  ...
                  <input type="text" @focus="processOnFosus(telusInput)" name ="vue-sendhelpform-telusername-input" class="vue-form-control" :class="{'vue-input-error':errorStyleTelus}" id="vue-sendhelpform-telusername-input" v-model="telusInput">
                </div>
                <div class="vue-form-item vue-sendhelpform-email-wr">
                  ...
                  <input type="text" @focus="processOnFosus(mailInput)" name ="vue-sendhelpform-email-input" class="vue-form-control" :class="{'vue-input-error':errorStyleMail}" id="vue-sendhelpform-email-input" v-model="mailInput">
                </div>
                <div class="vue-form-item vue-sendhelpform-button-wr">
                  <button type="submit" class="vue-btn vue-btn-normal vue-sendhelpform-button"><strong>Отправить</strong></button>
                </div>
              </fieldset>
            </form>
          </div>
