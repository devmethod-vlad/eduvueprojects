...
import FileItem from "@/questions/components/QuestionDetail/components/FileZone/components/FileItem/FileItem.vue";
import {computed, watch} from "vue";

// EMITS
const emits = defineEmits(['deleteitem','resetinfoarr']);
...
<style scoped>
@import "@/questions/components/QuestionDetail/components/FileZone/css/filezone.css";
</style>