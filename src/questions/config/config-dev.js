import {dev_secrets} from "@/questions/secrets/dev";
...
export const app_config_dev = {
    ...
    questionsUrl: '/eduportal/questions/questionslist/',

    spaceAndRolesUrl: '/eduportal/questions/spaceandroles/',

    serviceUrl: '/eduportal/questions/service/',

    statUrl: '/eduportal/questions/statistic/',

    saveOrUpdateUrl: '/eduportal/questions/saveorupdate/',

    attachmentsUrl: '/eduportal/questions/static/attachments',

    portalUrl: 'https://edu.emias.ru',

    staticUrls: {
        telbanner:'/eduportal/questions/static/imgs/'
    },
