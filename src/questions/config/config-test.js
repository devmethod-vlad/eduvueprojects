import {test_secrets} from "@/questions/secrets/test";

export const app_config_test = {

    prod: true,

    apiUrl: 'https://edu.emias.ru/edu-rest-api',

    authUrl: '/auth-test/authinfo/',

    questionsUrl: '/questions-test/questionslist/',

    spaceAndRolesUrl: '/questions-test/spaceandroles/',

    serviceUrl: '/questions-test/service/',

    statUrl: '/questions-test/statistic/',

    attachmentsUrl: '/questions-test/static/attachments',

    saveOrUpdateUrl: '/questions-test/saveorupdate/',

    portalUrl: 'https://edu.emias.ru',

    staticUrls: {
        telbanner:'/questions-test/static/imgs/'
    },
