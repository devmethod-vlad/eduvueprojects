    ...
    try{
        let resp = await fetch(app_config.apiUrl+app_config.filterMachineApiUrl, {
            ...
            body: JSON.stringify({
                ...
                'tempuserkey': params.tempuserkey,
                ...
                'user_searchinput': params.user_searchinput,
                'user_activepage': params.user_activepage,
                'user_sorting': params.user_sorting,
                'user_filters': params.user_filters,
                'user_pagecount': params.user_pagecount,
                'user_visibility_filters': params.user_visibility_filters
