...
async function getMoListInfo(params){
    try{
        ...
        const moResp = await fetch(app_config.apiUrl+app_config.enrolPluginApiUrl, {
            ...
            body: JSON.stringify({"action":"getmolist", "projectid":params.projectid,
                "filters": params.filters, "sorting": params.sorting, "pagecount": params.pagecount,
                ...
                "visibility_filters": params.visibility_filters
            })
        });
